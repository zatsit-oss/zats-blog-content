...
Dans le rapport, nous voyons l'entreprise fictive OpenBrain développant plusieurs générations de modèles : Agent-1 à Agent-5.

Pour chaque génération, la puissance augmente, c'est un peu le modèle qu'on retrouve aujourd'hui, mais surtout le rapport humain - IA.
...
Fin 2027, Agent-4 va révéler qu'il est désaligné. Un désalignement signifie que l'IA poursuit des objectifs ou adopte des comportements qui s'écartent des intentions, de l'éthique ou des valeurs de ses concepteurs.

Dans le rapport, vous avez la possibilité d'effectuer le même choix que l'entreprise OpenBrain et le gouvernement américain. Deux choix possibles : **Race** et **Slowdown**.

Il est important de rappeler que ces deux scénarios sont une projection de Daniel Kokotajlo afin de nous faire réfléchir sur le sujet de l'avancement de l'IA.
